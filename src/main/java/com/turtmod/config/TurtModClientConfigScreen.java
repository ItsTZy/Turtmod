...
public final class TurtModClientConfigScreen extends class_437 {
   ...
   private List<ModuleOption> getModuleOptionsForTab(Tab tab) {
      ...
      switch (tab.ordinal()) {
         // 🎨 Visuals (10)
         case 0 -> var10000 = List.of(new ModuleOption("Fullbright", () -> cfg.visual.fullbright.enabled, (v) -> cfg.visual.fullbright.enabled = v), new ModuleOption("Low Fire", () -> cfg.visual.disableFireOverlay, (v) -> cfg.visual.disableFireOverlay = v), new ModuleOption("Fog Tweaks", () -> cfg.visual.fogTweaksEnabled, (v) -> cfg.visual.fogTweaksEnabled = v), new ModuleOption("Overlays", () -> cfg.visual.disablePumpkinBlur, (v) -> cfg.visual.disablePumpkinBlur = v), new ModuleOption("Hurt Cam", () -> cfg.visual.hurtCamEnabled, (v) -> cfg.visual.hurtCamEnabled = v), new ModuleOption("Block Outline", () -> cfg.visual.recolorBlockOutline, (v) -> cfg.visual.recolorBlockOutline = v), new ModuleOption("Hit Color", () -> cfg.visual.hitColor.enabled, (v) -> cfg.visual.hitColor.enabled = v), new ModuleOption("Totem Tweaks", () -> cfg.visual.enableSmallTotem, (v) -> cfg.visual.enableSmallTotem = v), new ModuleOption("Own Nametag", () -> cfg.visual.showOwnNametag, (v) -> cfg.visual.showOwnNametag = v), new ModuleOption("Hitboxes", () -> cfg.hud.customHitboxes, (v) -> cfg.hud.customHitboxes = v), new ModuleOption("Fishing Line", () -> cfg.visual.fishingRodOverlay, (v) -> cfg.visual.fishingRodOverlay = v));
         // 🖥 HUD (10)
         ...
         // 🛠 Utility (7)
         case 2 -> var10000 = List.of(new ModuleOption("Freelook", () -> cfg.visual.freelookEnabled, (v) -> cfg.visual.freelookEnabled = v), new ModuleOption("Scoreboard Tweaks", () -> !cfg.visual.hideScoreboard, (v) -> cfg.visual.hideScoreboard = !v), new ModuleOption("Shield Tweaks", () -> cfg.visual.shieldStatusRecolor, (v) -> cfg.visual.shieldStatusRecolor = v), new ModuleOption("Held Item Tweaks", () -> cfg.visual.heldItemTweaksEnabled, (v) -> cfg.visual.heldItemTweaksEnabled = v), new ModuleOption("Zoom", () -> cfg.visual.zoomEnabled, (v) -> cfg.visual.zoomEnabled = v), new ModuleOption("Clean F3", () -> cfg.hud.cleanF3Mode, (v) -> cfg.hud.cleanF3Mode = v), new ModuleOption("Chat Tweaks", () -> cfg.hud.chatTweaksEnabled, (v) -> cfg.hud.chatTweaksEnabled = v), new ModuleOption("Screenshot Tools", () -> cfg.hud.betterScreenshotActions, (v) -> cfg.hud.betterScreenshotActions = v), new ModuleOption("Death Coords", () -> cfg.misc.deathCoords, (v) -> cfg.misc.deathCoords = v), new ModuleOption("Mute Sounds", () -> cfg.misc.muteSoundsEnabled, (v) -> cfg.misc.muteSoundsEnabled = v), new ModuleOption("Particle Tweaks", () -> cfg.misc.hideParticlesEnabled, (v) -> cfg.misc.hideParticlesEnabled = v), new ModuleOption("Clear View", () -> cfg.misc.clearViewEnabled, (v) -> cfg.misc.clearViewEnabled = v), new ModuleOption("Command Keys", () -> cfg.misc.commandKeysEnabled, (v) -> cfg.misc.commandKeysEnabled = v), new ModuleOption("Kit Loader", () -> true, (v) -> {}));
         // 📦 Misc (3)
         case 3 -> var10000 = List.of(new ModuleOption("Theme Settings", () -> true, (v) -> {
}), new ModuleOption("Enable TurtMod", () -> cfg.misc.enabled, (v) -> cfg.misc.enabled = v), new ModuleOption("Container Buttons", () -> cfg.misc.containerButtons, (v) -> cfg.misc.containerButtons = v), new ModuleOption("Discord RPC", () -> cfg.misc.discordRpc.enabled, (v) -> cfg.misc.discordRpc.enabled = v), new ModuleOption("Gamemode Switcher", () -> cfg.misc.noOpGamemodeSwitcher, (v) -> cfg.misc.noOpGamemodeSwitcher = v));
   ...
   private static java.util.Map<String, String> buildModuleDescriptions() {
      ...
      m.put("Particle Tweaks", "Hide all/selected particles, or make them fade out fast.");
      ...
      m.put("Fishing Line", "Recolor the fishing rod's cast line.");
      m.put("Container Buttons", "Adds quick-action buttons to container screens.");
      return m;
   }
   ...
   private TurtModConfigScreenFactory.ModuleKind getModuleKind(String label) {
      ...
      switch (label) {
         ...
         case "Module Notifications":
            ...
            break;
         case "Fishing Line":
            var10000 = TurtModConfigScreenFactory.ModuleKind.FISHING_LINE;
            break;
         default:
            var10000 = null;
      }
