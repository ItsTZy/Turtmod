...
public final class TurtModClientConfigScreen extends class_437 {
   ...
   private static java.util.Map<String, String> buildModuleDescriptions() {
      ...
      m.put("Totem Counter", "Totem icon + count on the HUD, with pops on nametags/tab.");
      m.put("Potion Counter", "Healing-pot icon + count on the HUD, with pots on nametags/tab.");
   ...
   private TurtModConfigScreenFactory.ModuleKind getModuleKind(String label) {
      ...
      switch (label) {
         ...
         case "Gamemode Switcher":
            ...
            break;
         case "Totem Counter":
            var10000 = TurtModConfigScreenFactory.ModuleKind.TOTEM_COUNTER;
            break;
         case "Potion Counter":
            var10000 = TurtModConfigScreenFactory.ModuleKind.POTION_COUNTER;
            break;
         default:
            var10000 = null;
      }
