...
public final class TurtModClientConfigScreen extends class_437 {
   ...
   private List<ModuleOption> getModuleOptionsForTab(Tab tab) {
      ...
      switch (tab.ordinal()) {
         ...
         // 🛠 Utility (7)
         case 2 -> var10000 = List.of(new ModuleOption("Freelook", () -> cfg.visual.freelookEnabled, (v) -> cfg.visual.freelookEnabled = v), new ModuleOption("Scoreboard Tweaks", () -> !cfg.visual.hideScoreboard, (v) -> cfg.visual.hideScoreboard = !v), new ModuleOption("Shield Tweaks", () -> cfg.visual.shieldStatusRecolor, (v) -> cfg.visual.shieldStatusRecolor = v), new ModuleOption("Held Item Tweaks", () -> cfg.visual.heldItemTweaksEnabled, (v) -> cfg.visual.heldItemTweaksEnabled = v), new ModuleOption("Zoom", () -> cfg.visual.zoomEnabled, (v) -> cfg.visual.zoomEnabled = v), new ModuleOption("Clean F3", () -> cfg.hud.cleanF3Mode, (v) -> cfg.hud.cleanF3Mode = v), new ModuleOption("Title Tweaks", () -> cfg.hud.titleTweaksEnabled, (v) -> cfg.hud.titleTweaksEnabled = v), new ModuleOption("Bossbar Tweaks", () -> cfg.hud.bossbarTweaksEnabled, (v) -> cfg.hud.bossbarTweaksEnabled = v), new ModuleOption("Chat Tweaks", () -> cfg.hud.chatTweaksEnabled, (v) -> cfg.hud.chatTweaksEnabled = v), new ModuleOption("Screenshot Tools", () -> cfg.hud.betterScreenshotActions, (v) -> cfg.hud.betterScreenshotActions = v), new ModuleOption("Death Coords", () -> cfg.misc.deathCoords, (v) -> cfg.misc.deathCoords = v), new ModuleOption("Mute Sounds", () -> cfg.misc.muteSoundsEnabled, (v) -> cfg.misc.muteSoundsEnabled = v), new ModuleOption("Hide Particles", () -> cfg.misc.hideParticlesEnabled, (v) -> cfg.misc.hideParticlesEnabled = v), new ModuleOption("Clear View", () -> cfg.misc.clearViewEnabled, (v) -> cfg.misc.clearViewEnabled = v), new ModuleOption("Command Keys", () -> cfg.misc.commandKeysEnabled, (v) -> cfg.misc.commandKeysEnabled = v), new ModuleOption("Kit Loader", () -> true, (v) -> {}));
         // 📦 Misc (3)
